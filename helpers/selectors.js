const selectors = {
  ...
  findCandidates: {
    ...
    detailsModal: {
      ...
      candidatePhoto: () => selectors.testId(''),
      candidateName: () => selectors.testId(''),
      jobTitle: () => selectors.testId(''),
      grade: () => selectors.testId(''),
      mobility: () => selectors.testId(''),
      location: () => selectors.testId(''),
      department: () => selectors.testId(''),
      businessUnit: () => selectors.testId(''),
      role: () => selectors.testId(''),
      unnassignedDate: () => selectors.testId(''),
      closeBtn: () => selectors.testId(''),
      goToProjectBtn: () => selectors.testId(''),
    },
  },
  unassignedPeople: {
    title: () => selectors.testId(''),
